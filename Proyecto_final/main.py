...
class BanfuturoApp(tk.Tk):
    ...
    def eliminar_cliente(self):
        ...
        self.entrada_id_eliminar.pack(pady=15, ipadx=10, ipady=5)
    ...
    def eliminar_gerente(self):
        ...
        self.entrada_id_eliminar = tk.Entry(frame_eliminar, font=("Arial", 18), width=30, bd=5, relief="solid")
        self.entrada_id_eliminar.pack(pady=15, ipadx=10, ipady=5)
